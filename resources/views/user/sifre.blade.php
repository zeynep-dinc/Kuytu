...
<div style="text-align:center;display:block;">
    <form action="/yenisifre" method='GET' style="display:inline-grid;margin-top:80px;">
    @csrf
    @if (isset($send) && $send == TRUE) 
        ...
        <label>Eposta kullanıcı adınız: </label><input type="text" name="uname" required=""><br>
        <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Gönder</button><br>
    </form>
